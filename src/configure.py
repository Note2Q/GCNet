...
parser.add_argument('--use_trivial', type=bool, default=False)
parser.add_argument('--trivial', type=bool, default=False)
parser.add_argument('--with_node_attention', type=bool, default=False)
parser.add_argument('--with_edge_attention', type=bool, default=False)
...
parser.add_argument('--mtl_method', type=str, default='structured_prediction',
                    choices=['stl', 'mtl', 'uw', 'gradnorm', 'dwa', 'lbtw', 'structured_prediction','causal_ebm'])
...
parser.add_argument('--output_model_file', type=str, default='output')
...
parser.add_argument('--PPI_pretrained_epochs', type=int, default=100)   #default = 100
...
parser.add_argument('--NCE_mode', type=str, default='uniform',
                    choices=[
                        ...
                        'mtl', 'uw', 'gradnorm', 'dwa', 'lbtw', 'gnn', 'casual_ebm', 'do_operation'
                    ])
...
parser.add_argument('--filling_mode', type=str, default='no_filling',
...
parser.add_argument('--ebm_GNN_use_concat', type=bool, default=True)
